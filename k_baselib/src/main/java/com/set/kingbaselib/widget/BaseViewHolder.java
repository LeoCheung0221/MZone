...
/**
 * author： LeoCheung4ever on 2016/5/1 08:59
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    private final SparseArray<View> views; //此处用SparseArray代替HashMap,基于性能优化考虑,IDE提示使用
    ...
    /**
     * 返回指定泛型的view
     * 先从Sparse数组中根据key值查找,有没有相应的缓存view,没有的话find出来,有直接返回
     */
